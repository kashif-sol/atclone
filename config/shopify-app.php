...
return [
    ...
    */
    ...
    'webhooks' => [
        [
            ...
            'address' => 'https://second-button.app.prod.fuznet.com/webhook/app-uninstalled'
        ],
        [
            'topic' => 'themes/publish',
            'address' => 'https://second-button.app.prod.fuznet.com/webhook/themes-publish'
        ]
        /*
            [
    ...
    */
    ...
    'scripttags' => [
         /*
        [
                'src' => env('SHOPIFY_SCRIPTTAG_1_SRC', env('APP_URL').'/clone-js.js'),
